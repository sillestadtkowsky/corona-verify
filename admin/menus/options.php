<?php
    ...
    function viewAdminOptions(){
        ...
        $html .= '<div class="wrap"><h3>Optionen</h3></div>
                <form method="POST">
                    <table class="form-table">
                        <tbody>
                            <tr class="cv_verifizierungskennzeichen">
                                ...
                                <td>		
                                    <input type="text" id="cv_verifizierungskennzeichen" name="cv_verifizierungskennzeichen" value="' .get_option(CV_OPTIONS::C_VERIFIZIERUNG_KENNZEICHEN). '" class="regular-text"> 
                            ...
                            <tr class="cv_verifizierungsstatus">
                                ...
                                <td>		
                                    <input type="text" id="cv_verifizierungsstatus" name="cv_verifizierungsstatus" value="' .get_option(CV_OPTIONS::C_VERIFIZIERUNG_STATUS). '" class="regular-text"> 
                            ...
                            <tr class="cv_max_rows">
                                ...
                                <td>		
                                    <input type="number" min="2" max="100" id="cv_max_rows" name="cv_max_rows" required value="' .get_option(CV_OPTIONS::C_TABLE_MAX_ROWS). '" class="regular-text"> 
                            ...
                            <tr class="cv_qr_support">
                                ...
                                <td>
                                    <input type="checkbox" name="cv_qr" value="yes"';
                                        if ( "yes" ===  get_option(CV_OPTIONS::C_QR_CODE) ){
                                            $html .= 'checked="checked" >';
                                        }else{
                                            $html .= ' >';
                                        }
                            $html .= '<div class="option_info">Legt fest, ob eine QR Code auf der Verifizierungsseite für einen Kunden angezeigt werden soll.</div>
                                </td>
                            </tr>
                            <tr class="cv_clean_db_by_uninstall">
                                ...
                                <td>
                                    <input type="checkbox" id="cv_clean_db_by_uninstall" name="cv_clean_db_by_uninstall" value="yes"';
                                        if ( "yes" === get_option(CV_OPTIONS::C_CLEAN_DB_BY_UNINSTALL)){
                                            $html .= ' checked="checked" >';
                                        } else{
                                            $html .= ' >';
                                        }
                            $html .= '<div class="option_info"><u>ACHTUNG!</u>  Legt fest, das bei einem Löschen des Plugin, die Tabellen ebenfalls entfernt werden. Dies kann <u>NICHT</u> rückgäng gemacht werden.</div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
